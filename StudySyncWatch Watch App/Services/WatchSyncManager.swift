        ...
        if events.isEmpty {
            events = [
                WatchEvent(id: UUID(), title: "期末考试周", emoji: "📝",
                          ...
                          categoryName: "学业", colorHex: "#5B7FFF", isPinned: false),
                WatchEvent(id: UUID(), title: "暑假回国", emoji: "✈️",
                          startDate: Date(),
                          endDate: Calendar.current.date(byAdding: .day, value: 90, to: Date())!,
                          categoryName: "旅行", colorHex: "#4ECDC4", isPinned: false),
                WatchEvent(id: UUID(), title: "签证到期", emoji: "📋",
